...
namespace PEPPOLSyncProgram
{
    ...
    public partial class Form1 : Form
    {
                        ...
                        if (!isDocExistAlready)
                        {
                            ...
                            { 
                                ...
                                else
                                {
                                    ...
                                    xmlDoc.Save(@"D:\TestNew.xml");
                                    XmlSerializer serializer1 = new XmlSerializer(typeof(CreditNote), new XmlRootAttribute("CreditNote"));

                                    using (FileStream fileStream = new FileStream(@"D:\TestNew.xml", FileMode.Open, FileAccess.Read, FileShare.Read))
                                    {
        ...
        private void SendCreditNote()
        {
            try
            {
                ...
                if (creditNoteHeaderObject != null)
                {
                    ...
                    TextWriter writer = new StreamWriter(@"D:\creditnotexml.xml");
                    ...
                    string filePath = @"D:\creditnotexml.xml";
        ...
        public static async Task<ReceivedResponse> uploadFileAsync(string InvoiceOrCredit, string docType, string filePath)
        {
            ...
            {
                httpClient.DefaultRequestHeaders.Add("Authorization", "Basic ZGIzOTdjODkyOWEwNDkxNWFhMzgxMWU2NmUwZTZiODI6ODM3NDllODQzNGRjNDM1YzkzZDA5NGY3NWJkMTRiNTA=");
